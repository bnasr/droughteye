...
write_delta_t_temporal <- function(y, m){
  ...
  prism_stable_path <- sprintf(fmt = '%sPRISM_tmean_stable_4kmM3_%04d%02d_bil/PRISM_tmean_stable_4kmM3_%04d%02d_bil.bil', 
                               prism_repo, y, m, y, m)
  
  prism_provisional_path <- sprintf(fmt = '%sPRISM_tmean_provisional_4kmM3_%04d%02d_bil/PRISM_tmean_provisional_4kmM3_%04d%02d_bil.bil', 
                                    prism_repo, y, m, y, m)
